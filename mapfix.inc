...
CreateMapFixObjects()
{
		...
		MapFixObjects[276] = mf_CreateFloorObject(19380, 2530.54443, -1686.45813, 1014.40601, 0.0, 90.0, 90.0, 15.0);//Floor
		MapFixObjects[277] = mf_CreateFloorObject(19380, 2530.54443, -1686.45813, 1018.08728, 0.0, 90.0, 90.0, 15.0);//Roof
		MapFixObjects[278] = mf_CreateFloorObject(2987, 2531.61938, -1683.73254, 1015.09741, 90.0, 0.0, 90.0, 15.0);//Bed
		mf_SetObjectMaterial(MapFixObjects[278], 0, 0, "none", "none", 0);
		MapFixObjects[279] = mf_CreateObject(19380, 2528.35889, -1685.86670, 1012.80792, 0.0, 0.0, 90.0, 15.0);//Windows
		mf_SetObjectMaterial(MapFixObjects[279], 0, 0, "none", "none", 0);
		MapFixObjects[280] = mf_CreateObject(19380, 2523.65454, -1682.65356, 1012.80792, 0.0, 0.0, 0.0, 15.0);//Entrance door
		mf_SetObjectMaterial(MapFixObjects[280], 0, 0, "none", "none", 0);
		MapFixObjects[281] = mf_CreateObject(19380, 2524.29712, -1681.10022, 1012.80792, 0.0, 0.0, 90.0, 15.0);
		MapFixObjects[282] = mf_CreateObject(19380, 2533.22949, -1685.99158, 1012.80792, 0.0, 0.0, 0.0, 15.0);
		MapFixObjects[283] = mf_CreateObject(19380, 2527.78931, -1685.99158, 1012.80792, 0.0, 0.0, 0.0, 15.0);
		MapFixObjects[284] = mf_CreateObject(2987, 2531.81665, -1680.98438, 1016.01349, 0.0, 0.0, 0.0, 15.0);
		MapFixObjects[285] = mf_CreateObject(2987, 2531.81665, -1681.21436, 1016.01349, 0.0, 0.0, 0.0, 15.0);
		MapFixObjects[286] = mf_CreateObject(1566, 2529.96094, -1681.09094, 1018.94672, 0.0, 90.0, 0.0, 15.0);
		MapFixObjects[287] = mf_CreateObject(1566, 2530.88599, -1681.34827, 1015.82813, 0.0, 0.0, -10.0, 15.0);//Bedroom door
		mf_SetObjectMaterial(MapFixObjects[287], 0, 0, "none", "none", 0);
		//Living room objects that have no collision
		MapFixObjects[288] = mf_CreateObject(2948, 2526.33423, -1681.80273, 1014.91553,  0.0, 90.0, 0.0, 15.0);
		mf_SetObjectMaterial(MapFixObjects[288], 0, 0, "none", "none", 0);
		MapFixObjects[289] = mf_CreateObject(2948, 2531.99219, -1675.79456, 1014.95160, 0.0, 90.0, 90.0, 15.0);
		mf_SetObjectMaterial(MapFixObjects[289], 0, 0, "none", "none", 0);
		MapFixObjects[290] = mf_CreateObject(2948, 2532.32666, -1681.72302, 1015.18958, 0.0, 90.0, 0.0, 15.0);
		mf_SetObjectMaterial(MapFixObjects[290], 0, 0, "none", "none", 0);
		MapFixObjects[291] = mf_CreateObject(2948, 2534.84009, -1672.75549, 1014.95160, 0.0, 90.0, 90.0, 15.0);
		mf_SetObjectMaterial(MapFixObjects[291], 0, 0, "none", "none", 0);
		MapFixObjects[292] = mf_CreateObject(2948, 2535.61230, -1672.75549, 1014.95160, 0.0, 90.0, 90.0, 15.0);
		mf_SetObjectMaterial(MapFixObjects[292], 0, 0, "none", "none", 0);
		MapFixObjects[293] = mf_CreateObject(2948, 2534.93945, -1676.52588, 1015.26349, 0.0, 0.0, 90.0, 15.0);
		mf_SetObjectMaterial(MapFixObjects[293], 0, 0, "none", "none", 0);
		MapFixObjects[294] = mf_CreateObject(2948, 2536.06152, -1676.52588, 1015.26349, 0.0, 0.0, 90.0, 15.0);
...
DestroyMapFixObjects()
{
	for(new i = sizeof(MapFixObjects) - 1; i >= 0; --i)
	{
		if(MapFixObjects[i])
		{
			if(i == 97 || 276 <= i <= 278 || i == 384 || i == 508 || 541 <= i <= 544 || 554 <= i <= 555) mf_DestroyFloorObject(MapFixObjects[i]);
